...
* **Github Mining for GPT-generated Code**: 
  ...
  * **Mined Languages**: Python, Java, C/C++, JavaScript, and TypeScript.
    ...
    > We select the [top 10 programming languages]([The top programming languages | The State of the Octoverse (github.com)](https://octoverse.github.com/2022/top-programming-languages)) from GitHub to download code in these programming languages, but we find that the number of GPT-generated code snippets in C#, PHP, Shell, and Ruby is less than 70, which may lead to statistically unreliable results. Consequently, we focus our analysis solely on GPT-generated code snippets in Python, Java, C/C++, JavaScript, and TypeScript on GitHub.
