...
def main():
    ...
    analyze_parser.add_argument('--llm', type=str, required=False, help='Default is ChatGPT', choices=["chatgpt"],
                                default="chatgpt")
    analyze_parser.add_argument('--lang', type=str, required=True, help='language',
                                choices=["python", "java", "javascript", "typescript", "c", "cpp"])
    analyze_parser.add_argument('--keyword', type=str, required=True, help='keyword',
                                choices=["generated", "created", "implemented", "written", "coded"])
    ...
    analyze_parser.add_argument('--extract', required=False, nargs="?", const=True, default=False,
                                help='Whether to save the extracted code. Default is False.')
    analyze_parser.add_argument('--diff', required=False, nargs="?", const=True, default=False,
                                help='Whether to perform a diff analysis on the code changes. Default is False.')
    analyze_parser.add_argument('--file', required=False, nargs="?", const=True, default=False,
                                help='Whether to download the files that contain the gpt-generated code in each '
                                     'commit. Default is False.')
    analyze_parser.add_argument('--project', required=False, nargs="?", const=True, default=False,
                                help='Whether to download the entire project of the commit that contains the first '
                                     'gpt-generated code. Default is False.')
    analyze_parser.add_argument('--commit', required=False, nargs="?", const=True, default=False,
                                help='Whether to download each commit message. Default is False.')
    ...
    statdist_parser.add_argument('--llm', type=str, required=False, help='Default is ChatGPT', choices=["chatgpt"],
                                 default="chatgpt")
    statdist_parser.add_argument('--lang', type=str, required=True, help='language',
                                 choices=["python", "java", "javascript", "typescript", "c", "cpp"])
    statdist_parser.add_argument('--change', required=False, nargs="?", const=True, default=False,
                                 help='Analyze only the GPT-generated code that has changes.')
    statdist_parser.add_argument('--percent', required=False,
                                 help='Analyze the top percentage of high-start projects, for example, 0.1 represents '
                                      'the top 10%. Deafult is 1.0')

    statall_parser = subparsers.add_parser('stat-all',
                                           help='Statistics summary of GPT-generated code characteristics in '
                                                'different languages.')
    ...
    draw_parser.add_argument('--RQ1', required=False, nargs="?", const=True, default=False,
                             help='Whether to plot the distribution of the stars, files, contributors, commits, '
                                  'bug-fix commits, and issues in the projects containing the GPT-generated code. '
                                  'Default is False.')
    draw_parser.add_argument('--RQ2', required=False, nargs="?", const=True, default=False,
                             help='Whether to plot the violin plot distribution of the LOC, cyclomatic complexity, '
                                  'and cognitive complexity of the GPT-generated code across the five programming '
                                  'languages. Default is False.')
    draw_parser.add_argument('--RQ3', required=False, nargs="?", const=True, default=False,
                             help='Whether to plot the violin plot distribution of the ratio of lines, average method '
                                  'cyclomatic complexity, average method cognitive complexity, average modification, '
                                  'and average bug-fix modification for GPT-generated code in the projects. Default '
                                  'is False.')

    mv_parser = subparsers.add_parser('mv',
                                      help='Read the results xlsx answered by gpt-4.0, move to the results statistics '
                                           'table csv of a certain language.')
    mv_parser.add_argument('--change', required=False, nargs="?", const=True, default=False,
                           help='Analyze only the GPT-generated code that has changes.')
    mv_parser.add_argument('--llm', type=str, required=False, help='Default is ChatGPT', choices=["chatgpt"],
                           default="chatgpt")
    mv_parser.add_argument('--lang', type=str, required=True, help='language',
                           choices=["python", "java", "javascript", "typescript", "c", "cpp"])

    crawl_parser = subparsers.add_parser('crawl',
                                         help='Based on search keywords, obtain detailed information about files, '
    ...
    stat_type = subparsers.add_parser("stat_type",
                                      help="Statistics of the code types, change types, and bug-fix types of "
                                           "GPT-generated code.")
    stat_type.add_argument('--llm', type=str, required=False, help='Default is ChatGPT', choices=["chatgpt"],
                           default="chatgpt")
    stat_type.add_argument('--lang', type=str, required=True, help='language',
                           choices=["python", "java", "javascript", "typescript", "c", "cpp"])
    stat_type.add_argument('--percent', required=False,
                           help='Analyze the top percentage of high-start projects, for example, 0.1 represents the '
                                'top 10%. Default is 1.0')
    ...
    if args.command == 'analyze':
        ...
        analyze_gpt_generated_code_and_more(args.llm, args.lang, args.keyword, start=args.start, end=args.end,
                                            is_save_code=args.extract, is_diff=args.diff, is_download_file=args.file,
        ...
        if args.RQ1:
            print(
                "Plot the distribution of the stars, files, contributors, commits, bug-fix commits, and issues in the "
                "projects containing the GPT-generated code.")
        ...
        if args.RQ2:
            print(
                "Plot the violin plot distribution of the LOC, cyclomatic complexity, and cognitive complexity of the "
                "GPT-generated code across the five programming languages.")
            draw_violinplot_from_different_metrics(
                ["code_locs", "code_complexity_all", "code_cognitive_complexity_all"],
                ['', '', ""],
                ['The lines of\ngenerated code', 'The CC of\ngenerated code',
                 'The CogC of\ngenerated code'], res_name="RQ2")
        if args.RQ3:
            print(
                "Plot the violin plot distribution of the ratio of lines, average method cyclomatic complexity, "
                "average method cognitive complexity, average modification, and average bug-fix modification for "
                "GPT-generated code in the projects")
        ...
        if not args.change:
            ...
            if args.lang == "python":
                read_xlsx_to_csv('results-code-change-type/python-code-change-type.xlsx', 'chatgpt', 'python',
                                 is_change=True)
            elif args.lang == "java":
                read_xlsx_to_csv('results-code-change-type/java-code-change-type.xlsx', 'chatgpt', 'java',
                                 is_change=True)
            elif args.lang == "javascript":
                read_xlsx_to_csv('results-code-change-type/javascript-code-change-type.xlsx', 'chatgpt', 'javascript',
                                 is_change=True)
            elif args.lang == "typescript":
                read_xlsx_to_csv('results-code-change-type/typescript-code-change-type.xlsx', 'chatgpt', 'typescript',
                                 is_change=True)
            elif args.lang == "cpp":
