...
def main():
    ...
    analyze_parser.add_argument('--llm', type=str, required=False, help='llm name', choices=["chatgpt"],
                                default="chatgpt")
    ...
    analyze_parser.add_argument('--file', required=False, nargs="?", const=True, default=False,
                                help='Whether to download the files that contain the gpt-generated code in each commit. Default is False.')
    analyze_parser.add_argument('--project', required=False, nargs="?", const=True, default=False,
                                help='Whether to download the entire project of the commit that contains the first gpt-generated code. Default is False.')
    ...
    analyze_parser.add_argument('--sonarqube', required=False, nargs="?", const=True, default=False,
                                help='Whether to analyze the gpt-generated code or project using SonarQube. Default is False.')

    statdist_parser = subparsers.add_parser('stat-dist',
                                            help='Statistics on the distribution of GPT-generated code characteristics in a particular language.')
    ...
    crawl_parser = subparsers.add_parser('crawl',
                                         help='Based on search keywords, obtain detailed information about files, projects, and repositories containing the keywords through precise searches on GitHub.')
    ...
    crawl_parser.add_argument("--get_page_wait_time", type=int, required=False, help="request page wait time",
                              default=10)
    crawl_parser.add_argument("--get_info_wait_time", type=float, required=False, help="get info wait time", default=0.4)
    ...
    if args.command == 'analyze':
        ...
        if args.RQ1:
            print(
                "Plot the distribution of the stars, files, contributors, commits, bug-fix commits, and issues in the projects containing the GPT-generated code.")
        ...
        if args.RQ2:
            print(
                "Plot the violin plot distribution of the LOC, cyclomatic complexity, and cognitive complexity of the GPT-generated code across the five programming languages.")
            draw_violinplot_from_different_metrics(
        ...
        if args.RQ3:
            print(
                "Plot the violin plot distribution of the ratio of lines, average method cyclomatic complexity, average method cognitive complexity, average modification, and average bug-fix modification for GPT-generated code in the projects")
